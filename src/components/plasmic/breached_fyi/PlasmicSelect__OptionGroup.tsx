...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: MkD1KqlHbwS/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: 6L7UEbA1yg8/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option___0YXch)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__n3MZy)}
              />
            </React.Fragment>
          ),
          value: args.children
